...
INSERT INTO `articole` (`id_articol`, `id_utilizator`, `id_categorie`, `titlu`, `continut`, `data_publicare`, `aprobat`) VALUES
(1, 1, 1, 'Arta abstracta', 'Descriere articol artistic...', '2023-01-01', 1),
...
INSERT INTO `articole_cititori` (`id_utilizator`, `id_articol`) VALUES
(3, 1),
(3, 4),
(4, 2);
...
CREATE TABLE `utilizatori` (
  ...
  `rol` enum('jurnalist','cititor','editor') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `utilizatori` (`id_utilizator`, `nume`, `email`, `parola`, `rol`) VALUES
(1, 'Jurnalist1', 'jurnalist1@example.com', 'parola123', 'jurnalist'),
(2, 'Jurnalist2', 'jurnalist2@example.com', 'parola456', 'jurnalist'),
(3, 'Cititor1', 'cititor1@example.com', 'parola789', 'cititor'),
(4, 'Editor1', 'editor1@example.com', 'parola000', 'editor');
...
--
ALTER TABLE `articole`
  MODIFY `id_articol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `articole`
  ADD CONSTRAINT `articole_ibfk_1` FOREIGN KEY (`id_utilizator`) REFERENCES `utilizatori` (`id_utilizator`),
...
--
ALTER TABLE `articole_cititori`
  ADD CONSTRAINT `articole_cititori_ibfk_1` FOREIGN KEY (`id_utilizator`) REFERENCES `utilizatori` (`id_utilizator`),
